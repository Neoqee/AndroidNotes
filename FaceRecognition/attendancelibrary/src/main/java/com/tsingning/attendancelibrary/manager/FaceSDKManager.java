package com.tsingning.attendancelibrary.manager;
...
import com.tsingning.attendancelibrary.DetectStatus;
import com.tsingning.attendancelibrary.api.FaceApi;
import com.tsingning.attendancelibrary.callback.FaceDetectCallBack;
import com.tsingning.attendancelibrary.db.DBManager;
import com.tsingning.attendancelibrary.listener.SdkInitListener;
import com.tsingning.attendancelibrary.model.GlobalSet;
            ...
            public void run() {
                ...
                if (faceInfos != null && faceInfos.length > 0) {
                    ...
                    if (faceDetectCallBack != null) {
                        DetectStatus.setMode(DetectStatus.MODE_FAST);
        ...
        future2 = es2.submit(new Runnable() {
            ...
            public void run() {
                ...
                if (faceInfos != null && faceInfos.length > 0) {
                    ...
                    rgbInstance.destory();
                    if (faceDetectCallBack != null) {
                        DetectStatus.setMode(DetectStatus.MODE_ACCURATE);
                ...
                if (!onQualityCheck(livenessModel, faceDetectCallBack)) {
                    rgbInstance.destory();
                    if (faceDetectCallBack != null) {
                        DetectStatus.setMode(DetectStatus.MODE_UN_QUALITY);
                        faceDetectCallBack.onFaceDetectCallback(livenessModel);
                    }
                    return;
                }
                ...
                // TODO 特征提取+人脸检索
                if (liveCheckMode == 0) {
                    onFeatureCheck(rgbInstance, faceInfos[0].landmarks, null,
                            null, livenessModel, featureCheckMode,
                ...
                // 显示最终结果提示
                if (faceDetectCallBack != null) {
                    DetectStatus.setMode(DetectStatus.MODE_FEATURE);
                    faceDetectCallBack.onFaceDetectCallback(livenessModel);
                }
