package com.tsingning.attendancelibrary.model;
...
//    private int detectDirection = 270;// oppo手机
    ...
    private float completeness = 0.5f;
    // 识别阈值，0-100，默认为80分,需要选择具体模型的阈值。live：80、idcard：80
    private int liveThreshold = 50;
    // 识别阈值，0-100，默认为80分,需要选择具体模型的阈值。live：80、idcard：80
    private int idThreshold = 50;
    // 识别阈值，0-100，默认为80分,需要选择具体模型的阈值。live：80、idcard：80
    private int rgbAndNirThreshold = 50;
    // 模态切换光线阈值
...
//    private int mirrorRGB = 1;      // 手机oppo
    // 0：NIR无镜像，1：有镜像
