 ...
 */
package com.tsingning.registerlibrary.api;
...
import com.tsingning.registerlibrary.model.Group;
import com.tsingning.registerlibrary.model.ImportFeatureResult;
...
public class FaceApi {
    ...
    public ImportFeatureResult getFeature(Bitmap bitmap, byte[] feature, BDFaceSDKCommon.FeatureType featureType) {
        ...
        // 人脸识别，提取人脸特征值
        float ret = FaceRegisterManager.getInstance().getFaceFeature().feature(
    ...
    public void initDatabases(final boolean isFeaturePush) {
        ...
        future = es.submit(new Runnable() {
            ...
            public void run() {
                ...
                if (isFeaturePush) {
                    FaceRegisterManager.getInstance().getFaceFeature().featurePush(features);
                }
